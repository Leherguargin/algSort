		...
		return (
			<div>
				...
				>
					...
					<Line type="monotone" dataKey="bubble_sort_time" stroke="#C8E40F" activeDot={{ r: 8 }} />
					<Line type="monotone" dataKey="bubble_with_flag" stroke="#F3040F" activeDot={{ r: 8 }} />
					<Line type="monotone" dataKey="recursive_quick_sort" stroke="#13040F" activeDot={{ r: 8 }} />
					{/* <Line type="monotone" dataKey="merge_sort_time" stroke="#82ca9d" /> */}
				</LineChart>
				{/* <p className="text-white">suma czasu: {this.psumaCzasow(this.props.dane)} s</p> */}
			</div>
		);
	}
}
